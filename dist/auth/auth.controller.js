...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Customer login — returns JWT' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Post)('technician/login'),
    (0, common_1.HttpCode)(200),
    (0, swagger_1.ApiOperation)({ summary: 'Technician login — returns JWT' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [LoginDto]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "loginTechnician", null);
